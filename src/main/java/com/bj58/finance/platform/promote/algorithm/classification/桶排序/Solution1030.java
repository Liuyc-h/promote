package com.bj58.finance.platform.promote.algorithm.classification.桶排序;
...
public class Solution1030 {
    ...
    /**
     *  桶排序
     *  桶排序就是将大范围划分为n个范围相同的桶子，在每个桶子里面排序，然后再进行连接
     *
     *  对于这道题，我们可以先求出这个算法算出来的最大值，即maxDist，分为maxDist + 1个桶
     *
     *  然后算出每个坐标所处的桶，放入桶里面，遍历这个桶，构造结果数据
     *
     *
     * **/
