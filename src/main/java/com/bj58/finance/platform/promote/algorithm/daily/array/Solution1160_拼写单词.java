 ...
 *
 * **/
public class Solution1160_拼写单词 {
    ...
    public int countCharacters(String[] words, String chars) {
        ...
        for(String str : words){
            ...
            Boolean flag = true;
            for(int i =0; i< 26; i++){
                if(strChar[i] > charsArray[i]){
                    flag = false;
                    break;
                }
            }

            result = flag ? (result + str.length()) : result;
        }
        return result;
    }
    ...
    public static void main(String[] args) {
        ...
        String s = "atach";
        System.out.println(new Solution1160_拼写单词().countCharacters(strs,s));
